...
Absolutely — here’s a focused documentation section specifically for **`Dispatcher:Publish()` with multiple return values**, ready to be added under your Dispatcher page:
